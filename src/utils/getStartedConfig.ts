      ...
      items: [
        {
          ...
          documentation: 'https://docs.cloudycamp.io/books/chart-of-accounts',
        },
        {
          ...
          documentation: 'https://docs.cloudycamp.io/books/setup-opening-balances',
        },
        {
          key: 'Add Taxes',
          label: t`Add Taxes`,
          ...
          documentation:
            'https://docs.cloudycamp.io/books/create-initial-entries#add-taxes',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          documentation:
            'https://docs.cloudycamp.io/books/create-initial-entries#add-sales-items',
        },
        {
          key: 'Add Customers',
          ...
          documentation:
            'https://docs.cloudycamp.io/books/create-initial-entries#add-customers',
        },
        {
          ...
          documentation: 'https://docs.cloudycamp.io/books/sales-invoices',
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          documentation:
            'https://docs.cloudycamp.io/books/purchase-invoices#creating-purchase-invoices',
        },
      ],
    },
  ];
